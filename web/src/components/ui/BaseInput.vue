  ...
  <div class="flex flex-col gap-1.5">
    ...
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        class="base-input w-full border border-gray-200 rounded-lg bg-white px-3 py-2 outline-none transition-all duration-200 dark:border-gray-700 dark:bg-gray-800 disabled:bg-gray-50 dark:text-white disabled:text-gray-400 dark:disabled:bg-gray-800/50"
        style="focus-border-color: var(--theme-primary); focus-ring: var(--theme-primary)"
